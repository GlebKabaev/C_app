...
namespace rabota2
{
    public partial class FormClient : Form
    {
        ...
        public void Update()
        {
            ...
            dataGridView2.Columns[3].HeaderText = "Наименование";
        ...
        private void StripMenu_Delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    int id = (int)dataGridView2.CurrentRow.Cells["id_supplier"].Value;
                    NpgsqlCommand command = new NpgsqlCommand("delete from supplier where id_supplier= :id", con);
        ...
        {
            int id = (int)dataGridView2.CurrentRow.Cells["id_supplier"].Value;
            string name = (string)dataGridView2.CurrentRow.Cells["sup_name"].Value;
            string phone = (string)dataGridView2.CurrentRow.Cells["phone"].Value;
            string adres = (string)dataGridView2.CurrentRow.Cells["email"].Value;
