...
namespace rabota2
{
    public partial class FuturaFormAdd : Form
    {
        ...
        public void Update()
        {
            ...
            comboBoxClient.DisplayMember = "sup_name";
            comboBoxClient.ValueMember="id_supplier";
        }
        ...
        private void add_button_Click(object sender, EventArgs e)
        {
                ...
                NpgsqlCommand cmd = new NpgsqlCommand("INSERT INTO futura (id_supplier,data,totalsum)" + "VALUES(:idclient,:data,0)",con);
